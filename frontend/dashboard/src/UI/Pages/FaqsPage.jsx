...
const FaqsPage = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      category: "devices",
      question:
        "Can NetPilot see devices connected through both Wi-Fi and Ethernet?",
      answer:
    ...
    },
    {
      ...
      category: "devices",
      question:
        "What's the difference between blocking a device and limiting it?",
      answer:
  ...
  return (
    <div className="max-w-3xl m-10 mx-auto">
      ...
      <div className="mb-6 space-y-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 text-sm rounded-lg dark:text-gray-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
          />
        </div>
